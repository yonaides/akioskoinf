 ...
 */
public class TurnoLlamarPnController implements Initializable {
    ...
    public void setTurno(Turno turno) {
        ...
        lbLlamando.setText("LLAMANDO");

        if (turno.isRellamar()) {
            lbLlamando.setText("RELLAMANDO");
        }
        ...
        if (turno.isEspecial()) {
            lbTurnoEspecial.getStyleClass().add("turno_especial_lg");
        } else {
            lbTurnoEspecial.getStyleClass().remove("turno_especial_lg");
        }
    }
